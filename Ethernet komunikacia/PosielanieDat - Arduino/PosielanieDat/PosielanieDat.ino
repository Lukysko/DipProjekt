...
char user[] = "sql7145161";              // MySQL user login username
char password[] = "hCUWvrahmL";        // MySQL user login password

int teplota = 40;
int ledPin = 13;
char query[255];

//Ziskanie hodnoty tepla
char selectOne[] = "INSERT INTO sql7145161.udaje_dom (teplota,ID_zakaznik) VALUES (%d,1) ";
//Ziskanie hodnoty svetla
char selecrTwo[] = "SELECT hodnota FROM sql7145161.svetlo where ID_zakaznik = '1' ";
...
void loop() {
  ...
  /*
    ...
    // Vytvorenie select-u
    sprintf(query, selectOne, teplota);
    ...
    // Vymazeme - uvolnime miesto v pamäti
    delete cur_mem;
  */
  ...
  //Vykonanie select-u
  cur_mem->execute(selecrTwo);

  // V nasom pripade nevyuzijeme, a vsak nezbytne - inak vypisuje chybu
  column_names *columns = cur_mem->get_columns();

  // Ziskame poslednu hodnotu svetla
  do {
